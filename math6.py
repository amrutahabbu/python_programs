...
userinput = eval(input("Enter the number of years to calculate population"))
...
print ("The total population after" +str(userinput) +" years would be " + str(current_population))
